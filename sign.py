...
# --- Enhanced Renaming and Metadata ---
...
def auto_rename_with_anitopy(file_path):
    ...
    try:
        ...
        # Shorten the anime name if it's too long
        shortened_title = shorten_anime_name(anime_title, max_length=25)

        # Create new filename
        output_name = f"{shortened_title} S{season}E{episode}.mkv"
        ...
        return new_file_path, thumbnail_path if download_cover_image(cover_url, thumbnail_path) else None, shortened_title
        ...
        try:
            ...
            if process.returncode == 0:
                ...
                if latest_file:
                    ...
                    latest_file, thumbnail_path, _ = auto_rename_with_anitopy(latest_file)
                    ...
                    try:
                        ...
                        await client.send_document(
                            ...
                            caption=f"`{os.path.basename(latest_file)}`",  # Use the filename as the caption
